    ...
    public void handleLoadPackage(final LoadPackageParam lpparam) throws Throwable {
        switch (lpparam.packageName) {
            case "com.netease.cloudmusic":
                XposedHelpers.findAndHookMethod("com.netease.nis.wrapper.MyApplication", lpparam.classLoader, "onCreate", new XC_MethodHook() {
                    @Override
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        //VersionControl.init((Context) param.thisObject);
                        XposedHelpers.findAndHookMethod(VersionControl.clazz, lpparam.classLoader, "showMinPlayerBar", boolean.class, new XC_MethodHook() {
                            @Override
...
//                    mArtistNameView.setPadding(dip2px(margin), 0, 0, 0);
            ...
            case "xyz.kymirai.cloudmusic":
                XposedHelpers.findAndHookMethod("xyz.kymirai.cloudmusic.MainActivity", lpparam.classLoader, "isActive", XC_MethodReplacement.returnConstant(true));
                break;
        }
    }
